 ...
 */
public class paymentInfo extends FragmentActivity implements View.OnClickListener{
    ...
    public void intview() {
        ...
        NonpaymentFr MallFragment = new NonpaymentFr();
        Havetopay WareFragment = new Havetopay();
